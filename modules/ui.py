...
def load_custom_css():
    # 1. Preparar o Background Dinâmico
    header_bg = ""
    ...
    # 2. Definir o CSS Estático (OBS: Sem dobrar chaves, CSS puro e limpo!)
    css_template = """
        <style>
    ...
    # 3. Injetar o background e renderizar
    final_css = css_template.replace("__HEADER_BG__", header_bg)
